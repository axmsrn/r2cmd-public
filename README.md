...
<p align="center">
  <img src="screenshots/screenshot.png" alt="R2Cmd Interface" width="900">
</p>
...
Get the latest release from [Releases page](https://www.google.com/search?q=https://github.com/axmsrn/R2Cmd/releases). Unpack and run `R2Cmd.exe` — no installation needed.
...
See [GitHub Issues](https://www.google.com/search?q=https://github.com/axmsrn/R2Cmd/issues) for full tracking.

---

## 🤝 Contributing

Contributions are welcome! See [CONTRIBUTING.md](https://www.google.com/search?q=CONTRIBUTING.md) for details.
...
- **Repository**: [github.com/axmsrn/R2Cmd](https://www.google.com/search?q=https://github.com/axmsrn/R2Cmd)
- **Issues**: [GitHub Issues](https://www.google.com/search?q=https://github.com/axmsrn/R2Cmd/issues)
